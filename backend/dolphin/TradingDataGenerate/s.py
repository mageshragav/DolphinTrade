...
m = s.get_hist(symbol=f'GBPJPY',exchange='FX',interval=Interval.in_5_minute,n_bars=9999,extended_session=False)
m.to_csv(f'common/MachineLearningModel/output/GBPJPY_5_Min_testing_new.csv') # _testing_new